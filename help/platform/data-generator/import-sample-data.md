...
* Experience Platform API에 액세스할 수 있으며 인증 방법을 알고 있습니다. 그렇지 않으면 이 [자습서](https://experienceleague.adobe.com/docs/platform-learn/tutorials/platform-api-authentication.html?lang=ko)를 검토하십시오.
