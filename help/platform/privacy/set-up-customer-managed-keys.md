...
>[!VIDEO](https://video.tv.adobe.com/v/3413985/?captions=kor&learn=on&enablevpops)
...
>[!WARNING]
>
>CMK를 설정한 후에는 시스템 관리 키로 되돌릴 수 없습니다. 사용자는 키를 안전하게 관리하고 Azure 내에서 Key Vault, Key 및 CMK 앱에 대한 액세스 권한을 제공하여 데이터에 대한 액세스 권한을 상실하지 않도록 해야 합니다.
