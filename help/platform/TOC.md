...
+ [시작하기: 데이터 설계자 및 데이터 엔지니어](https://experienceleague.adobe.com/ko/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview){target="_blank"}
...
+ AI 어시스턴트 {#ai-assistant}
   ...
   + [Agent Orchestrator 인터페이스](/help/platform/ai-assistant/agent-orchestrator-ui.md)
   ...
   + [AI 크레딧](/help/platform/ai-assistant/ai-credits.md)
...
+ 대상 및 세분화 {#audiences}
   ...
   + 튜토리얼{#audience-tutorials}
      ...
      + [데이터를 내보낼 데이터 세트 만들기](https://experienceleague.adobe.com/ko/docs/experience-platform/segmentation/tutorials/create-dataset-export-segment){target="_blank"}
      + [Data Warehouse의 대상과 협력](https://experienceleague.adobe.com/ko/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview){target="_blank"}
...
+ 공동 작업 {#collaboration}
   ...
   + [공동 작업자에게 대상 활성화](collaboration/activate-audiences-in-projects.md)
   + [Collaboration 측정 - 설정 및 보고서 만들기](collaboration/collaboration-measurement-setup-and-report-creation.md)
   + [브랜드에서 브랜드로](collaboration/brand-to-brand-collaboration.md)
   + [Collaboration을 사용하도록 파트너 초대](collaboration/rtcdp-collaboration-in-product-invitations.md)
+ 대시보드 {#dashboards}
...
+ 데이터 위생 {#data-hygiene}
   ...
   + [프로필 속성 업데이트](https://experienceleague.adobe.com/ko/docs/platform-learn/tutorials/profiles/update-a-specific-attribute-with-upsert)
+ 데이터 수집 {#data-ingestion}
   ...
   + [클라우드 스토리지에서 데이터 수집](https://experienceleague.adobe.com/ko/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage)
   + [CRM에서 데이터 수집](https://experienceleague.adobe.com/ko/docs/platform-learn/tutorials/sources/ingest-data-from-crm)
   + [데이터베이스에서 데이터 수집](https://experienceleague.adobe.com/ko/docs/platform-learn/tutorials/sources/ingest-data-from-databases)
   + [스트리밍 수집 개요](/help/platform/data-ingestion/understanding-streaming-ingestion.md)
   + [HTTP API를 사용하여 데이터 스트리밍](https://experienceleague.adobe.com/ko/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api)
   + [Source 커넥터를 사용하여 데이터 스트리밍](https://experienceleague.adobe.com/ko/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector)
...
+ 대상 {#destinations}
   ...
   + [Marketo Engage 대상 구성](/help/platform/destinations/configure-the-marketo-destination.md)
   ...
   + Data Warehouse {#data-warehouse}
      + [Snowflake 데이터 공유 배치로 대상 데이터 보내기](/help/platform/destinations/data-warehouse/send-audience-data-snowflake-batch.md)
...
+ 모니터링 {#monitoring}
   ...
   + [Slack과 통합](monitoring/monitor-events-in-slack.md)
...
+ 쿼리 및 데이터 Distiller {#queries}
   ...
   + [데이터 유효성 검사](/help/platform/queries/explore-data.md)
   ...
   + [타블로 연결](/help/platform/queries/psql-client-tableau.md)
   + [Tableau에서 데이터 분석 및 시각화](/help/platform/queries/analyze-and-visualize.md)
...
+ 스키마 {#schemas}
   ...
   + [애드혹 스키마 만들기](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/tutorials/ad-hoc){target="_blank"}
+ 소스 {#sources}
