...
+ [시작: 데이터 설계자 및 데이터 엔지니어](https://experienceleague.adobe.com/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview.html?lang=ko){target="_blank"}
...
+ 대상 및 세분화 {#audiences}
   ...
   + [대상 규칙 평가](https://experienceleague.adobe.com/docs/experience-platform/segmentation/tutorials/evaluate-a-segment.html?lang=ko){target="_blank"}
   + [데이터를 내보낼 데이터 집합을 만듭니다](https://experienceleague.adobe.com/docs/experience-platform/segmentation/tutorials/create-dataset-export-segment.html?lang=ko){target="_blank"}
...
+ [데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/data-collection/overview.html?lang=ko){target="_blank"}
+ 공동 작업 {#collaboration}
...
+ 데이터 수집 {#data-ingestion}
   ...
   + [XDM에 CSV 파일 매핑](https://experienceleague.adobe.com/docs/experience-platform/ingestion/tutorials/map-csv/existing-schema.html?lang=ko){target="_blank"}
   + [소스 개요](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/overview.html?lang=ko)
   + [Adobe Analytics에서 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=ko)
   + [Audience Manager에서 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-aam.html?lang=ko)
   ...
   + [데이터베이스로부터 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-databases.html?lang=ko)
   + [스트리밍 수집 개요](/help/platform/data-ingestion/understanding-streaming-ingestion.md)
   + [HTTP API로 데이터 스트리밍](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api.html?lang=ko)
   ...
   + [웹 SDK 자습서](https://experienceleague.adobe.com/docs/platform-learn/data-collection/web-sdk/overview.html?lang=ko){target="_blank"}
   + [모바일 SDK 자습서](https://experienceleague.adobe.com/docs/platform-learn/data-collection/mobile-sdk/overview.html?lang=ko){target="_blank"}
...
+ 프로필 {#profiles}
   ...
   + [프로필 보기 세부 정보 사용자 지정](https://experienceleague.adobe.com/docs/experience-platform/profile/ui/profile-customization.html?lang=ko){target="_blank"}
...
+ 쿼리 {#queries}
   ...
   + [데이터 준비](/help/platform/queries/prepare-data.md)
   ...
   + [쿼리 결과에서 데이터 세트 생성](https://experienceleague.adobe.com/docs/experience-platform/query/ui/create-datasets.html?lang=ko){target="_blank"}
   ...
   + [클라이언트를 쿼리 서비스에 연결](https://experienceleague.adobe.com/docs/experience-platform/query/clients/overview.html?lang=ko){target="_blank"}
...
+ 스키마 {#schemas}
   ...
   + [임시 스키마 만들기](https://experienceleague.adobe.com/docs/experience-platform/xdm/tutorials/ad-hoc.html?lang=ko){target="_blank"}
+ 소스 {#sources}
...
+ Experience Cloud 통합 {#experience-cloud}
   + [Analytics](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=ko)
   + [Audience Manager](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-aam.html?lang=ko)
   + [Commerce](/help/platform/experience-cloud/business-value-of-platform-and-commerce.md)
   + [Marketo Engage](https://experienceleague.adobe.com/docs/platform-learn/tutorials/rtcdp/orchestrate-campaigns-with-marketo-engage.html?lang=ko)
...
+ Summit {#summit}
   + 2025 {#2025}
      + 반바지 {#shorts}
         + 플랫폼 {#platform}
            + [비디오 요약](/help/summit/2025/shorts/platform/adobe-experience-platform--building-connected-customer-journeys.md)
            + [비디오 요약](/help/summit/2025/shorts/platform/adobe-s-internal-use-of-aep--driving-experience-led-growth.md)
            + [비디오 요약](/help/summit/2025/shorts/platform/architecting-adobe-experience-platform-for-scalability.md)
            + [비디오 요약](/help/summit/2025/shorts/platform/key-takeaways-for-deploying-aep-at-scale.md)
            + [비디오 요약](/help/summit/2025/shorts/platform/managing-data-governance-and-access-in-aep.md)
            + [비디오 요약](/help/summit/2025/shorts/platform/optimizing-aep-with-sandbox-tooling.md)
            + [비디오 요약](/help/summit/2025/shorts/platform/run-and-operate-strategies-for-aep-at-scale.md)
            + [비디오 요약](/help/summit/2025/shorts/platform/single-vs-multi-sandbox-approach-in-aep.md)
         + RTCDP {#rtcdp}
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/accelerating-your-audience-strategy-with-real-time-cdp.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/adobe-s-approach-to-audience-strategy-and-activation.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/adobe-s-approach-to-member-onboarding-and-retention.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/adobe-s-internal-use-of-aep--driving-retention-with-data-driven-journeys.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/adobe-s-internal-use-of-unified-profiles-for-creative-cloud.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/ai-assistant--boosting-productivity-in-audience-management.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/ai-assistant-for-audiences--optimizing-audience-strategies.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/audience-agent--proactive-audience-health-monitoring.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/audience-portal--centralizing-and-managing-audiences.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/audience-portal--centralizing-data-for-better-marketing-decisions.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/best-practices-for-data-modeling-in-adobe-experience-platform.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/best-practices-for-schema-design-in-adobe-experience-platform.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/creating-targeted-audiences-with-ai-assistant.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/customer-centric-approach-vs-campaign-centric-approach.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/defining-customer-experience-use-cases.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/discover--activate--and-measure-with-real-time-cdp-collaboration.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/end-to-end-use-case-activation-process.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/evolving-customer-experience-maturity.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/expanding-high-value-audiences-with-look-alike-models.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/federated-audience-composition--expanding-audience-reach.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/federated-audience-composition--expanding-your-reach.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/federated-audience-composition--unifying-data-for-real-time-marketing.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/how-ai-assistant-transforms-data-insights-in-real-time-cdp.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/how-ai-enhances-real-time-cdp-with-predictive-insights.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/how-real-time-cdp-collaboration-works.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/how-to-operate-and-communicate-effectively-in-tiger-teams.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/introducing-adobe-s-agent-orchestrator-for-intelligent-activation.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/introduction-to-real-time-cdp-collaboration.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/key-differentiators-of-real-time-cdp-collaboration.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/run-and-operate-strategies-for-scaling-adobe-experience-platform.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/the-power-of-ai-in-real-time-cdp-for-audience-optimization.md)
            + [비디오 요약](/help/summit/2025/shorts/rtcdp/three-phased-approach-to-audience-driven-marketing.md)
