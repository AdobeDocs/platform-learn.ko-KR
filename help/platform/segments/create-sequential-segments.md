---
title: 순차적 세그먼트 만들기
description: 이 비디오에서는 특정 시간 내에 특정 순서로 작업을 수행한 대상자를 만들기 위해 경험 이벤트를 세그먼트의 타임라인에 추가하는 방법을 알아봅니다.
feature: Segments
role: User
level: Beginner
...
이 비디오에서는 특정 시간 내에 특정 순서로 작업을 수행한 대상자를 만들기 위해 경험 이벤트를 세그먼트의 타임라인에 추가하는 방법을 알아봅니다.
