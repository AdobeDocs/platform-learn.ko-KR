...
| 응답 토큰 | 지원됨 | 지원됨. at.js와 Platform Web SDK 간의 코드 예제 및 차이점에 대해서는 [전용 응답 토큰 설명서](https://experienceleague.adobe.com/docs/target/using/administer/response-tokens.html?lang=ko)를 참조하십시오 |
...
[단일 페이지 애플리케이션용 Platform Web SDK을 사용하여 Target을 구현](https://experienceleague.adobe.com/docs/experience-platform/edge/personalization/adobe-target/spa-implementation.html?lang=ko)하는 방법에 대한 자세한 내용은 개발자 안내서를 참조하십시오.
