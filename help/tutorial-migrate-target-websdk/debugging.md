...
[Adobe Experience Platform Debugger 확장](https://experienceleague.adobe.com/docs/experience-platform/debugger/home.html)과 모든 Adobe 웹 응용 프로그램을 디버깅하는 방법에 대한 자세한 내용은 전용 안내서를 참조하세요.
