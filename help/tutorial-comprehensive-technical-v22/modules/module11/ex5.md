...
프로젝트를 엽니다. `--demoProfileLdap-- - Omnichannel Analysis`.
...
그런 다음 테이블에서 처음 5개를 선택합니다 **사용자 에이전트**  우리가 수행한 분석의 행 **Google Pixel XL 32GB 블랙 스마트폰** > **시티신호**. 3행을 선택하는 동안 **CTRL** 단추(Windows의 경우) 또는 **명령** 단추(Mac에서).
