...
1. [Luma 홈 페이지](https://luma.enablementadobe.com)&#x200B;(태그 속성에 매핑됨)와 **Adobe Experience Platform Debugger**&#x200B;을(를) 열고 페이지를 새로 고칩니다.
...
1. 태그 속성에 매핑된 상태로 [Luma 데모 웹 사이트 홈 페이지](https://luma.enablementadobe.com)를 열어 새로 만든 세그먼트를 확인합니다.
