...
* Adobe Audience Manager에 대한 액세스 권한과 트레이트, 세그먼트 및 대상을 만들고, 읽고, 쓸 수 있는 적절한 권한이 있습니다. 자세한 내용은 [Audience Manager의 역할 기반 액세스 제어](https://experienceleague.adobe.com/ko/docs/audience-manager-learn/tutorials/setup-and-admin/user-management/setting-permissions-with-role-based-access-control)를 검토하십시오.
...
1. [Luma 홈 페이지](https://newluma.enablementadobe.com)&#x200B;(태그 속성에 매핑됨)와 **Adobe Experience Platform Debugger**&#x200B;을(를) 열고 페이지를 새로 고칩니다.
...
1. 태그 속성에 매핑된 상태로 [Luma 데모 사이트 홈 페이지](https://newluma.enablementadobe.com)를 열어 새로 만든 세그먼트를 확인합니다.
...
1. **`https://newluma.enablementadobe.com`** 도메인을 선택하고 쿠키가 목록에 적절히 작성되었는지 확인하십시오
