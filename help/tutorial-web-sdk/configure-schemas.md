...
>[!NOTE]
>
> 데모 목적으로 이 단원의 연습에서는 [Luma 데모 웹 사이트](https://luma.enablementadobe.com)에서 본 콘텐츠 및 고객이 구매한 제품을 캡처하는 예제 스키마를 빌드합니다. 계속 진행하여 이 예제 스키마를 만들어 스키마 편집기의 기능을 알아보십시오. 그러면 나중에 귀하의 비즈니스를 위한 스키마를 빌드할 준비가 더 됩니다.
...
이 연습에서는 [Luma 데모 웹 사이트](https://luma.enablementadobe.com){target="_blank"}에서 웹 이벤트 데이터를 캡처하기 위한 권장 기준 필드 그룹을 사용하여 XDM 스키마를 만듭니다.
