...
>[!NOTE]
>
> 데모 목적으로 이 단원의 연습에서는 자격 증명, [사용자: ](https://newluma.enablementadobe.com)/암호: 테스트&#x200B;**를 사용하여 `test@test.com`Luma 데모 사이트**&#x200B;에 로그인한 가상 고객의 ID 세부 정보를 캡처합니다.
...
1. 다음과 같이 세부 정보를 입력하고 **[!UICONTROL 만들기]**&#x200B;를 선택하세요.
   ...
   새 ID 네임스페이스가 **[!UICONTROL 네임스페이스]** 화면에 표시됩니다.

   ![네임스페이스를 만들었습니다](assets/configure-identities-namespace-lumaCrmId.png)
