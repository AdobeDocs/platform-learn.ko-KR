...
1. **[!UICONTROL Edge 세그멘테이션]**&#x200B;을 사용하도록 설정합니다.

1. **[!UICONTROL 저장]**&#x200B;을 선택합니다.

   ![데이터 스트림 구성](assets/experience-platform-datastream-config.png)

태그 속성에 매핑된 [Luma 데모 사이트](https://newluma.enablementadobe.com)에서 트래픽을 생성하면 데이터가 Experience Platform의 데이터 세트를 채웁니다!
...
1. [Luma 데모 사이트](https://newluma.enablementadobe.com)를 열고 [!UICONTROL Experience Platform 디버거] 확장 아이콘을 선택합니다.
