...
태그 속성에 매핑된 [Luma 데모 사이트](https://luma.enablementadobe.com)에서 트래픽을 생성하면 데이터가 Experience Platform의 데이터 세트를 채웁니다!
...
1. [Luma 데모 사이트](https://luma.enablementadobe.com)를 열고 [!UICONTROL Experience Platform 디버거] 확장 아이콘을 선택합니다.
