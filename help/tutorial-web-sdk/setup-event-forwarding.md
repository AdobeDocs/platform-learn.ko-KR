...
1. [Luma 데모 웹 사이트](validate-with-debugger.md#use-the-experience-platform-debugger-to-map-to-your-tag-property)에서 태그 라이브러리를 [전환](https://luma.enablementadobe.com/category-men.html)하는 단계를 따라 데이터 스트림에서 이벤트 전달 속성을 매핑한 웹 SDK 태그 속성으로 전환합니다.
