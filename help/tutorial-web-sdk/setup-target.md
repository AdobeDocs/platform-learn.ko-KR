...
>[!NOTE]
>
>이 자습서에서는 태그 및 플리커 완화 기능이 비동기적으로 구현된 [Luma 웹 사이트](https://luma.enablementadobe.com){target=_blank}를 사용합니다. 이 섹션은 Platform Web SDK에서 플리커 완화가 작동하는 방식을 이해하는 데 참조됩니다.
...
1. [Luma 데모 웹 사이트](https://luma.enablementadobe.com)&#x200B;(으)로 이동
1. 제품 세부 사항 페이지로 이동
