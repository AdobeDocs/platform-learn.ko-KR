...
* **Journey Optimizer**&#x200B;의 경우:
   * 선택적 **웹 캠페인** 단원의 경우 **[!UICONTROL 캠페인 관리]**, **[!UICONTROL 캠페인 게시]** 및 **[!UICONTROL 캠페인 보고서 보기]**&#x200B;에 대한 권한 항목이 있어야 합니다.
  <!--
...
[![Luma 웹 사이트](assets/old-overview-luma.png)](https://newluma.enablementadobe.com){target="blank"}
