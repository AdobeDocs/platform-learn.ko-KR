...
이제 데이터 설계자와 데이터 엔지니어 모두가 일반적으로 사용하는 플랫폼 기능에 대한 실무 경험을 갖추게 되었습니다. 귀하의 역할은 둘 중 하나일 뿐이며 동료가 종종 수행하는 _많은_ 작업을 수행했음을 이해합니다. 이렇게 함으로써 모든 것이 어떻게 서로 잘 맞는지, Experience Platform을 성공적으로 구현하는 데 필요한 팀워크를 높이 평가할 수 있기를 바랍니다.

학습 내용:

* **데이터 설계자**&#x200B;가 종종 수행되는 Admin Console의 사용자 및 권한 관리
* **데이터 설계자** 및 **데이터 엔지니어** 모두가 새 스키마와 데이터를 실험하는 데 사용할 수 있는 샌드박스를 만드십시오
* Developer Console에서 Platform API에 대한 액세스를 설정하고 **데이터 설계자** 및 **데이터 엔지니어**&#x200B;가 모두 유용한 Experience Platform Postman 컬렉션을 사용합니다
...
* **데이터 엔지니어**&#x200B;가 일반적으로 웹 개발자와 조정해야 하는 Adobe Experience Platform Web SDK을 사용하여 데이터를 스트리밍합니다.
...
* [Experience League 교육 과정](https://experienceleague.adobe.com/ko#dashboard/learning)
