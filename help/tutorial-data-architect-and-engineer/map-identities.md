...
1. `Luma Loyalty Id`ID 네임스페이스&#x200B;**[!UICONTROL 드롭다운에서]** 네임스페이스를 선택합니다.
1. **[!UICONTROL 적용]** 선택
1. **[!UICONTROL 저장]** 선택
...
1. `Luma CRM Schema`에서 `crmId` 네임스페이스를 사용하여 `Luma CRM Id` 필드에 기본 ID로 레이블을 지정합니다.
1. `Luma Offline Purchase Events Schema`에서 `loyaltyId` 네임스페이스를 사용하여 `Luma Loyalty Id` 필드에 기본 ID로 레이블을 지정합니다.
1. `Luma Product Catalog Schema`에서 `productSku` 네임스페이스를 사용하여 `Luma Product SKU` 필드에 기본 ID로 레이블을 지정합니다.
...
1. `crmId` 필드 선택
1. **[!UICONTROL ID]** 상자를 선택합니다.
1. `Luma CRM Id`ID 네임스페이스&#x200B;**[!UICONTROL 드롭다운에서]** 네임스페이스를 선택합니다.
