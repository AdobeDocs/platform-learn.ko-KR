...
1. 로그인 시트를 열려면 ![사용자](/help/assets/icons/User.svg) 버튼을 선택합니다.
...
1. 제품 하나를 선택하십시오.
1. ![하트](/help/assets/icons/Heart.svg)를 선택하세요.
1. ![장바구니](/help/assets/icons/ShoppingCart.svg)를 선택하십시오.
1. ![신용 카드](/help/assets/icons/CreditCard.svg)를 선택하십시오.

   <img src="./assets/mobile-app-events-3.png" width="300">

1. **[!UICONTROL 홈]** 화면으로 돌아갑니다. ![UserCheckedOut](/help/assets/icons/UserCheckedOut.svg) 배지가 추가되었습니다.
...
1. 무작위 전자 메일 및 고객 ID를 삽입하려면 **[!UICONTROL 무작위 전자 메일 생성]** 을 선택합니다.
1. **[!UICONTROL 로그인]**&#x200B;을 선택합니다.
...
1. 탭 표시줄에서 **[!DNL Products]**&#x200B;을(를) 선택합니다.
1. 제품 하나를 선택하십시오.
1. ![ThumbUp](/help/assets/icons/ThumbUp.svg) 선택
1. ![장바구니](/help/assets/icons/ShoppingCart.svg)를 선택하십시오.
1. ![신용 카드](/help/assets/icons/CreditCard.svg)를 선택하십시오.
