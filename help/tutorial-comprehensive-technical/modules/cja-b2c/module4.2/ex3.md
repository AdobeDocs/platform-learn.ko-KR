...
이제 **Google 인증 플랫폼** 홈 페이지가 표시됩니다. **GET 시작됨**&#x200B;을 클릭합니다.
...
그런 다음 OAuth 앱을 게시해야 합니다. **대상**(으)로 이동하여 **PUBLISH 앱**&#x200B;을 클릭합니다.
...
## 4.2.3.3 BigQuery API 및 refreshToken
