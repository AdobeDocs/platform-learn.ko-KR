...
Kinesis과 S3는 모두 [프로필 내보내기 대상](https://experienceleague.adobe.com/docs/experience-platform/destinations/destination-types.html?lang=ko)이며 Adobe Experience Platform Real-Time CDP의 일부로 사용할 수 있습니다.
