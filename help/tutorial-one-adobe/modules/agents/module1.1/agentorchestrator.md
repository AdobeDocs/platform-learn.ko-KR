...
[1.1.1 AI Assistant 및 Agent Orchestrator](./ex1.md){target="_blank"}

이 연습에서는 Fibre Max용 CitiSignal 출시 캠페인의 배경에 대해 AI Assistant 및 Agent Orchestrator을 살펴봅니다.
...
[1.1.4 Google Gemini Enterprise용 Adobe Marketing Agent](./ex4.md){target="_blank"}
...
이 연습에서는 Adobe Marketing Agent과 Claude를 함께 사용하여 Fibre Max에 대한 CitiSignal 출시 캠페인의 배경에 대한 Agent Orchestrator의 능력을 살펴봅니다.

[1.1.6 AI 하네스](./ex5.md){target="_blank"}

이 연습에서는 Fibre Max에 대한 CitiSignal 출시 캠페인을 배경으로 새로운 AI Harness를 사용하여 Agent Orchestrator의 기능을 살펴봅니다.
