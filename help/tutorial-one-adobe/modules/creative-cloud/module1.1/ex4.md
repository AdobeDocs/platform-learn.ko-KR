...
![사용자 지정 모델 Firefly](./images/ffcm1.png){zoomable="yes"}

이 메시지가 표시됩니다. 계속하려면 **동의**&#x200B;를 클릭하세요.

![사용자 지정 모델 Firefly](./images/ffcm2.png){zoomable="yes"}

그럼 이걸 보셔야죠 **모델 교육**&#x200B;을 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm3.png){zoomable="yes"}
...
![사용자 지정 모델 Firefly](./images/ffcm4.png){zoomable="yes"}

새 프로젝트에 이름을 지정하십시오. `--aepUserLdap-- - Custom Models`. **만들기**&#x200B;를 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm5.png){zoomable="yes"}

그럼 이걸 보셔야죠 **만들기**&#x200B;를 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm6.png){zoomable="yes"}

이제 교육할 사용자 정의 모델에 대한 참조 이미지를 제공해야 합니다. **컴퓨터에서 이미지 선택**&#x200B;을 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm7.png){zoomable="yes"}

참조 이미지 [여기](https://tech-insiders.s3.us-west-2.amazonaws.com/CitiSignal_router.zip)를 다운로드하십시오. 다운로드 파일의 압축을 풀고 해당 파일을 제공합니다.

![사용자 지정 모델 Firefly](./images/ffcm8.png){zoomable="yes"}

다운로드 이미지 파일이 포함된 폴더로 이동합니다. 모두 선택하고 **열기**&#x200B;를 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm9.png){zoomable="yes"}

그러면 이미지가 로드되는 것을 볼 수 있습니다.

![사용자 지정 모델 Firefly](./images/ffcm10.png){zoomable="yes"}
...
![사용자 지정 모델 Firefly](./images/ffcm11.png){zoomable="yes"}

모든 이미지에 요구 사항을 충족하는 캡션이 추가되더라도 샘플 프롬프트를 제공해야 합니다. &#39;router&#39;라는 단어를 사용하는 프롬프트를 입력하십시오. 이를 완료하면 모델 교육을 시작할 수 있습니다. **교육**&#x200B;을 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm12.png){zoomable="yes"}

그러면 이걸 보게 될 거야. 모델을 교육하는 데 20~30분 이상 걸릴 수 있습니다.

![사용자 지정 모델 Firefly](./images/ffcm13.png){zoomable="yes"}

20~30분 후 모델이 이제 교육되어 게시될 수 있습니다. **Publish**&#x200B;을(를) 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm14.png){zoomable="yes"}

**Publish**&#x200B;을 다시 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm15.png){zoomable="yes"}

**사용자 지정 모델 공유** 팝업을 닫습니다.

![사용자 지정 모델 Firefly](./images/ffcm16.png){zoomable="yes"}

## 1.1.4.2 UI에서 맞춤형 모델 사용

[https://firefly.adobe.com/cme/train](https://firefly.adobe.com/cme/train)(으)로 이동합니다. 사용자 정의 모델을 클릭하여 엽니다.

![사용자 지정 모델 Firefly](./images/ffcm19.png){zoomable="yes"}

**미리 보기 및 테스트**&#x200B;를 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm17.png){zoomable="yes"}

그런 다음 실행되기 전에 입력한 샘플 프롬프트가 표시됩니다.

![사용자 지정 모델 Firefly](./images/ffcm18.png){zoomable="yes"}

## 1.1.4.3 Firefly 서비스 사용자 지정 모델 API에 대해 사용자 지정 모델 활성화

사용자 지정 모델이 교육되면 API를 통해서도 사용할 수 있습니다. 연습 1.1.1에서는 API를 통해 Firefly 서비스와 상호 작용하기 위해 Adobe I/O 프로젝트를 이미 구성했습니다.
...
![사용자 지정 모델 Firefly](./images/ffcm20.png){zoomable="yes"}

Firefly 사용자 지정 모델에 액세스하려면 사용자 지정 모델을 Adobe I/O 프로젝트의 **기술 계정 ID**&#x200B;에 공유해야 합니다.
...
![사용자 지정 모델 Firefly](./images/ffcm24.png){zoomable="yes"}

**OAuth 서버 간**&#x200B;을 클릭합니다.

![사용자 지정 모델 Firefly](./images/ffcm25.png){zoomable="yes"}

**기술 계정 ID**&#x200B;를 복사하려면 클릭하세요.

![사용자 지정 모델 Firefly](./images/ffcm23.png){zoomable="yes"}

**기술 계정 ID**&#x200B;를 붙여넣고 **편집하려면 초대**&#x200B;를 클릭하세요.

![사용자 지정 모델 Firefly](./images/ffcm21.png){zoomable="yes"}

이제 **기술 계정 ID**&#x200B;에서 사용자 지정 모델에 액세스할 수 있습니다.

![사용자 지정 모델 Firefly](./images/ffcm22.png){zoomable="yes"}

## 1.1.4.4 Firefly 서비스 사용자 지정 모델 API와 상호 작용
