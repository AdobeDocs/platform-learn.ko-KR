...
# Workfront Fusion을 사용한 프로세스 자동화

Workfront Fusion을 사용하여 자동화를 처리하는 방법에 대해 알아봅니다.
...
[Firefly 서비스 자동화의 요약 및 이점](./summary.md){target="_blank"}(으)로 이동
