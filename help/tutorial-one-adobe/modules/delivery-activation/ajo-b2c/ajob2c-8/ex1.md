...
왼쪽 메뉴에서 **채널**(으)로 이동합니다. **채널 구성 만들기**&#x200B;를 클릭합니다.

![AJO OC](./images/ajoocchannel1.png)

`--aepUserLdap---citisignal-email-oc` 이름을 사용합니다. 채널 **전자 메일** 선택

![AJO OC](./images/ajoocchannel2.png)

사용 가능한 **하위 도메인** 및 **IP 풀**&#x200B;을 선택하세요.

![AJO OC](./images/ajoocchannel3.png)

아래로 스크롤하여 **헤더 매개 변수**&#x200B;를 채웁니다.

- **이름에서**: `info@techinsiders.org`
- **전자 메일 접두사의**: `info`
- **이름에 회신**: `info@techinsiders.org`
- **전자 메일에 회신**: `info@techinsiders.org`
- **오류 전자 메일 접두사**: `error`

![AJO OC](./images/ajoocchannel4.png)

아래로 스크롤합니다. **오케스트레이션된 캠페인**(으)로 이동합니다. **사용**&#x200B;에 대한 확인란을 선택합니다. **대상 차원**&#x200B;을(를) 선택하십시오.

![AJO OC](./images/ajoocchannel5.png)

**프로필 대상 Dimension**&#x200B;에 대해 `--aepUserLdap--_citisignal_recipients - email`을(를) 선택합니다.

**대상 Dimension**&#x200B;을 선택하고 **폴더 열기** 아이콘을 클릭합니다.

![AJO OC](./images/ajoocchannel6.png)

`--aepUserLdap--_citisignal_recipients`을(를) 클릭합니다.

![AJO OC](./images/ajoocchannel7.png)

필드 **전자 메일**&#x200B;을(를) 선택하고 **선택**&#x200B;을(를) 클릭합니다.
