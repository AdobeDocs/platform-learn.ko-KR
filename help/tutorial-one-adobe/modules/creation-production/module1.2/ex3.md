...
# 1.2.3 Frame.io 및 Workfront Fusion
...
이 연습을 계속하기 전에 Adobe I/O 프로젝트에 [Frame.io API](./../../../modules/getting-started/gettingstarted/ex6.md)를 추가하는 등 **Adobe I/O 프로젝트** 설정을 완료하고 [Postman](./../../../modules/getting-started/gettingstarted/ex7.md) 또는 [PostBuster](./../../../modules/getting-started/gettingstarted/ex8.md)와 같이 API와 상호 작용할 응용 프로그램을 구성해야 합니다.

## 1.2.3.2 Frame.io 액세스
...
## 1.2.3.3 Workfront Fusion 및 Frame.io
...
## 1.2.3.4 Frame.io V4 사용자 지정 작업 API
...
[https://next.frame.io/](https://next.frame.io/){target="_blank"}(으)로 돌아가서 프로젝트 **에서 만든** CitiSignal 파이버 캠페인`--aepUserLdap--` 폴더로 이동합니다. 페이지를 새로 고칩니다.
...
## 1.2.3.5 Frame.io에 사용자 지정 양식 응답을 제공합니다.
...
Frame.io로 돌아가서 자산 `--aepUserLdap-- - Frame IO Custom Action Fusion`citisignal-fiber.psd **에서 사용자 지정 작업**&#x200B;을(를) 다시 클릭합니다.
...
## 1.2.3.6 Frame.io에서 파일 위치를 검색합니다.
...
그런 다음 **시작** 모듈의 일부로 구성한 Adobe I/O 프로젝트의 **클라이언트 ID** 및 **클라이언트 암호**&#x200B;을(를) 입력해야 합니다. Adobe I/O 프로젝트 **여기**&#x200B;에서 **클라이언트 ID** 및 [클라이언트 암호](https://developer.adobe.com/console/projects.){target="_blank"}를 찾을 수 있습니다.
...
Frame.io로 돌아가서 자산 `--aepUserLdap-- - Frame IO Custom Action Fusion V4`citisignal-fiber.psd **에서 사용자 지정 작업**&#x200B;을(를) 다시 클릭합니다.
...
## 1.2.3.9 엔드 투 엔드 사용 사례 테스트

시나리오 **에서**&#x200B;한 번 실행`--aepUserLdap-- - Frame IO Custom Action`을 클릭합니다.
...
Workfront Fusion으로 다시 전환합니다. 시나리오 **에서**&#x200B;한 번 실행`--aepUserLdap-- - Frame IO Custom Action V4`을 클릭합니다.
...
[1.2.4 Frame.io에서 AEM Assets으로 이동](./ex4.md){target="_blank"}
