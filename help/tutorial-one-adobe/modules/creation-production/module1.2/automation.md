...
[커넥터를 사용하는 1.2.2 자동화](./ex2.md){target="_blank"}

이 연습에서는 이미지 생성 프로세스를 자동화하기 위해 여정을 계속 세분화합니다.

[1.2.3 Frame.io 및 Workfront Fusion](./ex3.md){target="_blank"}

이 연습에서는 Frame.io를 Workfront Fusion 시나리오에 연결합니다.

Workfront Fusion에서 AEM Assets으로 [1.2.4 Frame.io](./ex4.md){target="_blank"}
