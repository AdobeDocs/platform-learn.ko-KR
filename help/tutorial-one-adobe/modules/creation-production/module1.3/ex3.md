---
title: Meta에 GenStudio for Performance Marketing Campaign 활성화
description: Meta에 GenStudio for Performance Marketing Campaign 활성화
role: Developer
level: Beginner
jira: KT-5342
doc-type: Tutorial
...
필드 **채널**&#x200B;의 경우 **Meta**, **이메일**, **유료 미디어**, **디스플레이**(으)로 설정하십시오.
...
## Meta에 대한 1.3.3.2 설치 연결

>[!IMPORTANT]
>
>Meta에 대한 연결을 설정하려면 사용 가능한 Meta 사용자 계정이 있어야 하며 해당 사용자 계정을 Meta Business 계정에 추가해야 합니다.

Meta에 대한 연결을 설정하려면 세 점 **..**&#x200B;을(를) 클릭하고 **설정**&#x200B;을(를) 선택하십시오.

![GSPeM](./images/gsconnection1.png)

**Meta 광고**&#x200B;에 대해 **연결**&#x200B;을 클릭합니다.

![GSPeM](./images/gsconnection2.png)

Meta 계정을 사용하여 로그인합니다. **계속**&#x200B;을 클릭합니다.

![GSPeM](./images/gsconnection3.png)

계정이 Meta 비즈니스 계정에 연결되어 있으면 Meta에서 구성한 비즈니스 포트폴리오를 선택할 수 있습니다.
...
**폴더 선택**&#x200B;을 클릭합니다. 에셋 이름을 `--aepUserLdap-- - neon rabbit`(으)로 변경합니다.
...
## 1.3.3.4 Meta 광고 만들기 및 승인

왼쪽 메뉴에서 **만들기**(으)로 이동합니다. **Meta**&#x200B;을(를) 선택합니다.

![GSPeM](./images/gsad1.png)

이전에 가져온 **Meta 광고** 템플릿을 선택합니다(이름이 `--aepUserLdap---citisignal-meta-ad`임). **사용**&#x200B;을 클릭합니다.
...
이제 4개의 Meta 광고를 **콘텐츠** > **경험**&#x200B;에서 사용할 수 있습니다.
...
Meta 계정, 연결된 Facebook 페이지, Meta Campaign 및 Meta 광고 세트를 선택합니다.
...
몇 분 후에 광고 상태가 **게시됨**(으)로 변경됩니다. 즉, 광고가 GenStudio for Performance Marketing에서 Meta으로 전송되었습니다. 광고가 이미 Meta에 게시되었음을 의미하지는 않습니다! Meta 비즈니스 계정에서 광고를 가져와서 게시하여 다양한 Meta 플랫폼의 사용자가 볼 수 있도록 하는 여러 가지 단계가 아직 있습니다.

**세부 정보 보기**&#x200B;를 클릭합니다.

![GSPeM](./images/gsmetaad8.png)

**열기**&#x200B;를 클릭하면 Meta 비즈니스 계정으로 이동합니다.

>[!IMPORTANT]
>
>환경에 연결된 Meta 비즈니스 계정에 액세스할 수 없는 경우 Meta에서 이 광고를 시각화할 수 없습니다.

![GSPeM](./images/gsmetaad9.png)

다음은 방금 만든 광고와 이제 Meta의 개요입니다.
