---
title: 새 자산 만들기, 검토 및 승인
description: 새 자산 만들기, 검토 및 승인
role: Developer
level: Beginner
jira: KT-5342
doc-type: Tutorial
...
## 1.8.2.2 Adobe Firefly 및 Adobe Express을 사용하여 새 에셋 만들기
...
프로젝트 관리자는 이제 해당 이미지의 현재 버전을 볼 수 있으므로 어떤 일이 일어나고 있으며 이 작업이 활발하게 진행되고 있는지 알 수 있습니다. **Frame.io에서 열기**&#x200B;를 클릭합니다.

![WF](./images/wffio15.png)

그런 다음 새 창이 열리고 Frame.io에서 자산이 표시됩니다.
