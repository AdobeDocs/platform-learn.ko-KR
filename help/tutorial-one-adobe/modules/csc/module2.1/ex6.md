...
**const AUDIENCES = {...};**&#x200B;에서 아래 코드를 붙여넣습니다.
...
## 2.1.6.5 Adobe Experience Platform Edge Network으로 데이터 보내기
...
## 2.1.6.6 Adobe Experience Platform에서 고객 프로필 보기
