...
이 연습에서는 Adobe의 Web SDK에 대한 &#39;원시&#39; 구성을 수행하고 Adobe Journey Optimizer Offer decisioning에서 다음 최적 오퍼를 요청합니다.
...
**alloy.js** 라이브러리는 웹 사이트에서 Adobe의 Edge Network으로, 그리고 Adobe Experience Platform, Adobe Analytics, Adobe Target 등의 응용 프로그램으로 요청을 보낼 수 있는 Web SDK을 연결하는 라이브러리입니다.
...
이 코드 블록은 Experience Cloud ID(ECID)의 값을 검색하는 데 사용됩니다. ECID는 브라우저의 고유 디바이스 식별자입니다.
...
요청에는 이 ECID에서 확인해야 하는 오퍼에 대한 결정을 Adobe Journey Optimizer Offer decisioning에게 요청하는 2 **결정 범위**&#x200B;가 지정됩니다.
