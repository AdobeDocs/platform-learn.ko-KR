...
[1.1.2 AEM CS 환경 설정](./ex2.md){target="_blank"}

이 연습에서는 AEM CS 환경을 설정하고 CitiSignal 웹 사이트에 액세스합니다.

[1.1.3 기본 사용자 지정 블록](./ex3.md){target="_blank"}

이 연습에서는 웹 사이트에 대한 기본 사용자 지정 블록을 개발합니다.

[1.1.4 고급 사용자 지정 블록](./ex4.md){target="_blank"}

이 연습에서는 웹 사이트에 대한 고급 사용자 지정 블록을 개발합니다.

[1.1.5 AEM Edge Delivery Services MarTech 플러그인](./ex5.md){target="_blank"}
