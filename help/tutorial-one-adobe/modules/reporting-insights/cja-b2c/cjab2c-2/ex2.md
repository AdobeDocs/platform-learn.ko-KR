...
## 1.2.2.1 새 BigQuery 테이블을 저장할 데이터 집합을 만듭니다.
...
생성한 테이블에서 데이터가 준비되기까지 시간이 걸릴 수 있습니다. 몇 분 후에 브라우저를 새로 고칩니다. 그러면 데이터 세트 내에서 BigQuery 프로젝트 내의 `--aepUserLdap--_GAdataTableBigquery`탐색기&#x200B;**아래에** 테이블이 표시됩니다.
