...
이 비디오에서는 이 자습서의 Adobe Experience Platform 및 애플리케이션 부분에 있는 아키텍처에 대해 알아봅니다.
...
[2.4 Real-Time CDP: Audience Activation - Microsoft Azure 이벤트 허브](./modules/delivery-activation/rtcdp-b2c/rtcdpb2c-4/segment-activation-microsoft-azure-eventhub.md)
