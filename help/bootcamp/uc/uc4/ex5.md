...
프로젝트를 열고 데이터 보기를 사용하여 `CJA Bootcamp - Omnichannel Data View` 선택한 경우 첫 번째 시각화 작성을 시작할 준비가 되었습니다.
...
>[!IMPORTANT]
>
>19/09/2022에 가장 최근에 사용 가능한 데이터를 수집했습니다. 이 날짜를 포함하는 날짜 범위를 선택하십시오.
...
상위 4개 제품을 찾아 보겠습니다. 왼쪽 메뉴에서 **제품 이름** - Dimension.
...
다음으로, 충성도 수준을 사용하여 분류를 수행합니다. 검색 대상 **충성도 수준** 브랜드 이름 아래로 끌어서 놓습니다.
...
그런 다음 테이블에서 3을 선택합니다 **충성도 수준**  우리가 수행한 분석의 행 **Google Pixel XL 32GB 블랙 스마트폰** > **시티신호**. 3행을 선택하는 동안 **CTRL** 단추(Windows의 경우) 또는 **명령** 단추(Mac에서).
