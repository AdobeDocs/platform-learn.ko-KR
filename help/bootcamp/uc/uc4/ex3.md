...
이 탭에서 몇 가지 중요한 설정을 수정하여 데이터 처리 방법을 변경할 수 있습니다. 먼저 **세션 시간 초과** 30분까지 모든 경험 이벤트의 타임스탬프 덕분에 모든 채널에서 세션의 개념을 확장할 수 있습니다. 예를 들어 고객이 웹 사이트를 방문한 후 콜 센터에 전화하면 어떻게 됩니까? 사용자 지정 세션 시간 초과를 사용하면 세션 정의와 해당 세션이 데이터를 함께 병합하는 방법을 결정할 수 있습니다.
